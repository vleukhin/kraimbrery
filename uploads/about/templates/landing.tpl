...
<div class="yellow-block">
    ...
    {if $mari_soc.instagram?}<a href="{$mari_soc.instagram}" target="_blank" class="fa fa-instagram" aria-hidden="true"></a>{/if}
    {if $mari_soc.facebook?}<a href="{$mari_soc.facebook}" target="_blank" class="fa fa-facebook" aria-hidden="true"></a>{/if}
</div>
<div class="gradient">
    <div class="carousel-box">
        <div class="slider-01 owl-carousel owl-theme">
            <img src="uploads/slider-top/01.jpg" alt="">
            <img src="uploads/slider-top/02.jpg" alt="">
            <img src="uploads/slider-top/01.jpg" alt="">
        </div>
    </div>
</div>
<div class="gradient">
    ...
    <div class="text-info color-yellow">
        {if $who_is_she_img?}<div><img src="{$who_is_she_img}" alt=""></div>{/if}
        {if $who_is_she_head?}<div class="strong">{$who_is_she_head}</div>{/if}
        {if $who_is_she_intro?}<div class="intro-text">{$who_is_she_intro}</div>{/if}
        {if $who_is_she_full?}<div class="full-text">{$who_is_she_full}</div>{/if}
    ...
    <div class="ticket">
        ...
        <div class="table color-yellow">
            ...
            <div class="link"><a href="#" class="btn">Купить билет</a></div>
        </div>
        <div class="table color-yellow">
    ...
    <div class="contacts-box">
        <div class="btn-line">
            <div class="contacts">
                ...
                {if $organization.name?}<div>{$organization.name}</div>{/if}
            </div>
            {if $organization.phone?}<div><a href="tel:{$organization.phone}">{$organization.phone}</a></div>{/if}
        </div>
    </div>
    <div class="contacts-box">
        <div class="btn-line">
            <div class="contacts">
                ...
                {if $manager.name?}<div>{$manager.name}</div>{/if}
            </div>
            {if $manager.phone?}<div><a href="tel:{$manager.phone}">{$manager.phone}</a></div>{/if}
            {if $manager.email?}<div><a href="mailto:{$manager.email}">{$manager.email}</a></div>{/if}
        </div>
    </div>
    <div class="contacts-box">
        ...
        {if $velvet_address?}<address>{$velvet_address}</address>{/if}
        {if $velvet_phone?}<div><a href="tel:{$velvet_phone}" target="_blank">{$velvet_phone}</a></div>{/if}
        {if $velvet_email?}<div><a href="mailto:{$velvet_email}" target="_blank">{$velvet_email}</a></div>{/if}
        {if $velvet_site?}<div><a href="http://{$velvet_site}" target="_blank">{$velvet_site}</a></div>{/if}
    </div>
    <div class="velvet-soc">
        {if $velvet_soc.vk?}<a href="{$velvet_soc.vk}" target="_blank" class="fa fa-vk" aria-hidden="true"></a>{/if}
        {if $velvet_soc.instagram?}<a href="{$velvet_soc.instagram}" target="_blank" class="fa fa-instagram" aria-hidden="true"></a>{/if}
        {if $velvet_soc.youtube?}<a href="{$velvet_soc.youtube}" target="_blank" class="fa fa-youtube-play" aria-hidden="true"></a>{/if}
    </div>
</div>
